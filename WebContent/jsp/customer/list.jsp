										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													...
													<TD>客户来源：</TD>
													<TD>
														<select id="custSource" name="dictSource.dict_id">
															<option value="">--请选择--</option>
														</select>
													</TD>
													<TD>客户行业：</TD>
													<TD>
														<select id="custIndustry" name="dictIndustry.dict_id">
															<option value="">--请选择--</option>
														</select>
													</TD>
													<TD>客户等级：</TD>
													<TD>
														<select id="custLevel" name="dictLevel.dict_id">
															<option value="">--请选择--</option>
														</select>
													</TD>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD><s:property value="dictLevel.dict_item_name"/></TD>
													<TD><s:property value="dictSource.dict_item_name"/></TD>
													<TD><s:property value="dictIndustry.dict_item_name"/></TD>
